...
**evanverse** provides 60+ utility functions designed to streamline R
workflows across data analysis, visualization, statistical testing, and
bioinformatics. Built with a focus on simplicity and reproducibility.
...
**Statistical Analysis** — t-test, ANOVA, chi-square, correlation
analysis, power analysis, and sample size calculation with automatic
assumption checking
