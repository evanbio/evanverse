...
This document defines the **official naming convention** for color
palettes in the evanverse package. Following these standards ensures:

- **Self-documenting names** - Instantly understand palette type and
  purpose
...
**Core Principle**: `type_name_source` structure with lowercase and
underscores.
...
4.  **Type prefix required** - Must start with `seq_`, `div_`, or
    `qual_`
...
**Document Version**: 1.0 **Last Updated**: 2025-11-12 **Status**:
Official Standard
