...
types and publication-ready visualizations.
...
Statistical testing with automatic method selection, assumption
checking, and publication-ready output. Power and sample size tools.

- [`quick_ttest()`](https://evanbio.github.io/evanverse/reference/quick_ttest.md)
  [`plot(`*`<quick_ttest_result>`*`)`](https://evanbio.github.io/evanverse/reference/quick_ttest.md)
...
- [`quick_anova()`](https://evanbio.github.io/evanverse/reference/quick_anova.md)
  [`plot(`*`<quick_anova_result>`*`)`](https://evanbio.github.io/evanverse/reference/quick_anova.md)
  : One-way comparison with automatic method selection
- [`quick_chisq()`](https://evanbio.github.io/evanverse/reference/quick_chisq.md)
  [`plot(`*`<quick_chisq_result>`*`)`](https://evanbio.github.io/evanverse/reference/quick_chisq.md)
...
- [`quick_cor()`](https://evanbio.github.io/evanverse/reference/quick_cor.md)
  [`plot(`*`<quick_cor_result>`*`)`](https://evanbio.github.io/evanverse/reference/quick_cor.md)
...
Gene ID conversion, gene reference download, and gene set analysis
tools.
...
Functions that generate small reproducible datasets for testing and
demonstration.
