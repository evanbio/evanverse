...
test_that("read_table_flex() handles different encodings", {
  ...
  expect_s3_class(dt_utf8, "data.table")

  dt_latin1 <- read_table_flex(tmp, encoding = "latin1")
  expect_s3_class(dt_latin1, "data.table")
